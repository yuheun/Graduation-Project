      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.person_outline), label: '개인 정보'),
        ],
        ...
        child: Column(
          children: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      ...
                      image: (userData.profileImgUrl != null &&
                              userData.profileImgUrl!.isNotEmpty)
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text:
                                  "${userData.nickname.isNotEmpty ? userData.nickname : 'OOO'} 님",
                              style: TextStyle(
                                fontSize: 23,
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text:
                                  "${userData.mylocation != null ? userData.mylocation! : '지역구를 선택하세요'}",
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w800,
                                color: Color.fromARGB(255, 78, 103, 169),
                ...
                ElevatedButton(
                  ...
                  style: ButtonStyle(
                    minimumSize: MaterialStateProperty.all(
                        Size(screenWidth * 0.4, screenHeight * 0.23)),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const FindGoodsScreen()));
                  },
                  style: ButtonStyle(
                    minimumSize: MaterialStateProperty.all(
                        Size(screenWidth * 0.4, screenHeight * 0.23)),
            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                minimumSize: MaterialStateProperty.all(
                    Size(screenWidth * 0.9, screenHeight * 0.25)),
                backgroundColor: MaterialStateProperty.all<Color>(
            ...
            InkWell(
              ...
              child: const Row(
                children: [
                  SizedBox(width: 15),
                  Icon(Icons.loyalty,
                      size: 30, color: Color.fromARGB(255, 119, 119, 119)),
                  SizedBox(width: 15),
                  Text("알림받는 키워드",
                      style: TextStyle(
                          fontSize: 20,
